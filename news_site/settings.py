...
INSTALLED_APPS = [
    ...
    # MY_APPS
    'news_site_news',
    'news_site_news_category',
    'news_site_news_author',
    'news_site_news_tag',
    'news_site_account',
    'news_site_main_news_index',
    'news_site_advertise',
    'news_site_setting',
    'news_site_gallery',
...
MIDDLEWARE = [
    ...
    'news_site_news.middlewere.SaveIPAddressMiddleware',
]
...
AUTH_USER_MODEL = "news_site_account.User"
